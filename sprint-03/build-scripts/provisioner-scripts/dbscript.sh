...
# Run SQL command
sed -i "s/\$ACCESSFROMIP/$ACCESSFROMIP/g" ~/2021-team03t/sprint-03/code/db/create-user-with-permissions.sql
sed -i "s/\$USERPASS/$USERPASS/g" ~/2021-team03t/sprint-03/code/db/create-user-with-permissions.sql
