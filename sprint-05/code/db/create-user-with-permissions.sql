...
GRANT SELECT,INSERT,UPDATE, DELETE, INDEX, ALTER,  DROP, LOCK TABLES, CREATE ON $DATABASENAME.* TO john@'$ACCESSFROMIP' IDENTIFIED BY '$USERPASS';
flush privileges;

GRANT SELECT,INSERT,UPDATE, DELETE, INDEX, ALTER,  DROP, LOCK TABLES, CREATE ON $DATABASENAME.* TO paul@'$ACCESSFROMIP' IDENTIFIED BY '$USERPASS';
flush privileges;